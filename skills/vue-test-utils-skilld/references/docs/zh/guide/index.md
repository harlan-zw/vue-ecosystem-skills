...
Vue Test Utils 是最小化且不含偏见的库。如果你想要功能更丰富、更易用且偏好更鲜明的工具，获取可以考虑具有热重载开发环境的 Cypress Component Testing、或者在断言时强调基于可访问性选择器的 Testing Library。这两种工具在底层都使用 Vue Test Utils 并暴露相同的 API。
