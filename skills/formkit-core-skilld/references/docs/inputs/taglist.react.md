...
In React JSX props like <code>allowNewValues</code>, <code>loadOnCreated</code>, <code>emptyMessage</code>, and <code>reloadOnCommit</code> use the standard prop casing for that framework.
...
#### taglist-allow-new-values.react.jsx
...
#### taglist-single-request.react.jsx
...
#### taglist-pagination-option-loader.react.jsx
...
#### taglist-load-on-created.react.jsx
...
In React this is typically implemented with <code>tag</code>, <code>option</code>, and related entries on the <code>slots</code> prop.

In this example, we are going to use the `tag` slot to customize the look of the tags:

### Example: Taglist

#### taglist-slots.react.jsx
...
#### taglist-empty-message.react.jsx
...
#### taglist-close-on-select.react.jsx
...
#### taglist-reload-on-commit.react.jsx
...
#### taglist-open-on-click.react.jsx
...
#### taglist-open-on-focus.react.jsx
...
#### taglist-open-on-remove.react.jsx
...
#### taglist-full-example.react.jsx
