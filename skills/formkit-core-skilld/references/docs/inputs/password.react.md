...
When controlling this input in React, prefer `modelValue` and `onUpdateModelValue`. If you use icon props for visibility toggles in JSX, remember they follow camelCase prop names like `suffixIcon`.
