...
> **Tip:** Need more flexibility than the native HTML `date` input provides? [Check out the datepicker input](/inputs/datepicker) available in FormKit Pro.

## Basic example

### Example: Date input

#### date-example.react.jsx
