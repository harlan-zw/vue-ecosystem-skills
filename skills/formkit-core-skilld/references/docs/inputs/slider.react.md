...
In React JSX props like <code>tooltipFormat</code>, <code>showInput</code>, <code>inputAttrs</code>, <code>markLabels</code>, and <code>snapToMarks</code> use the standard prop casing for that framework.
...
In React this is typically implemented with <code>maxHandleInner</code> and <code>minHandleInner</code> entries on the <code>slots</code> prop.

### Example: Slider Input

#### customizing-handle.react.jsx
