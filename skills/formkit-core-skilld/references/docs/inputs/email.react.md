...
> **Tip:** Need more flexibility than the native HTML `email` input provides? [Check out the mask input](/inputs/mask) available in FormKit Pro.

## An example

### Example: Email input

#### email-example.react.jsx
