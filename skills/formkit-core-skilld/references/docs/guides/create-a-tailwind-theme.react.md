...
> **Warning:** If you are using `pnpm` you will need to ensure you have the `formkit` command line package as a dev dependency in your project. If you are not using `pnpm` you can skip this step.
```
pnpm add -D formkit
...
> **Tip:** If you're using Tailwind CSS 3, add the theme file to your `tailwind.config.js` content array instead:
```
// tailwind.config.js
module.exports = {
