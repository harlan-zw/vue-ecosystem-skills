...
> **Info:** If an input is inside a [form](/inputs/form), then *any* remaining validation messages will be displayed to the end user when a user attempts to submit the form.
...
#### validation-visibility.react.jsx
...
#### rule-contains-alphanumeric.react.jsx
...
#### rule-contains-alpha-spaces.react.jsx
...
#### rule-contains-lowercase.react.jsx
...
#### rule-contains-numeric.react.jsx
...
#### rule-contains-symbol.react.jsx
...
#### rule-contains-uppercase.react.jsx
...
#### rule-matches-inline-regex.react.jsx
...
#### rule-matches-array-syntax.react.jsx
...
#### custom-validation-dependency.react.jsx
...
To use a validation rule anywhere in your project, you can specify it wherever your FormKit configuration is registered for your framework.
...
#### validation-custom-messages.react.jsx
...
#### validation-custom-messages-function.react.jsx
...
If there are validation rule messages you'd like to override (or add) across your entire project, you can define those message rules in your framework config under the language key you'd like to override:
...
> **Tip:** FormKit 1.0.0 introduced the [FormKitSummary](/inputs/form#validation-and-error-summary) component which provides an "out of the box" solution to for displaying all the validation messages in a given form or subtree.
