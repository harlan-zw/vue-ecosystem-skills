...
You can deploy your VitePress project with CloudRay by following these instructions.
...
You can deploy your VitePress project with Hostinger by following these instructions. While configuring build settings, choose VitePress as the framework and adjust the root directory to `./docs`.
