...
This is only relevant for [Single-File Components](/guide/scaling-up/sfc). It does _not_ require that the `scoped` attribute be used. Scoping could be through CSS modules, a class-based strategy such as BEM, or another library/convention.
