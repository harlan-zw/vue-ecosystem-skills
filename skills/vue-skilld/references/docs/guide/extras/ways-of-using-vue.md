...
We previously provided an alternative distribution called petite-vue that was specifically optimized for progressively enhancing existing HTML. However, petite-vue is no longer actively maintained, with the last version published at Vue 3.2.27. 
...
- Build desktop apps with Electron or Wails
...
- Use Vue's [Custom Renderer API](/api/custom-renderer) to build custom renderers, like those for the terminal!
