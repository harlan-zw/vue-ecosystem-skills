...
- TanStack Intent documentation — the CLI's full reference, including `scaffold`, `validate`, and CI setup for library maintainers.
- Agent Skills registry — browse other intent-enabled packages.
